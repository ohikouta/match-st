    ...
    <body>
        <header class="w-full">
            <div class="bg-blue-500 text-white p-4">
                <a href="{{ route('users.index') }}" class="sm:text-2xl md:text-4xl block font-bold">交流プラットフォーム</a>
            </div>
            ...
            <div class="bg-blue-500 p-4 flex justify-between">
                ...
                <div class="flex justify-between">
                    ...
                    <!-- 通知ボタン -->
                    <a id="notification-button" onclick="toggleNotification()" class="text-xl bg-green-500 p-2 ml-4 rounded-md hover:bg-green-600"><i class="fas fa-bell"></i></a>
                    <div>
                        <!-- クリックしたら表示する通知セクション -->
                    ...
                    <div class="sm:order-2 md:order-2 lg:order-1 lg:flex-6 lg:w-3/5 mx-4">
                        <div class="flex flex-col">
                            ...
                            <div class="border border-solid border-gray-300 shadow-md mt-5 rounded-lg">
                                <h3 class="sm:text-lg py-10 lg:py-20 text-4xl text-white font-bold flex justify-center" style="background-image: url('{{ $individualImage->url }}'); background-position: center center;">
                                    コミュニティ
                                </h3>
                                <div class="p-5">
                                    <div class="mt-4">
                            ...
                            <div class="border border-solid border-gray-300 shadow-md mt-5 mb-5 rounded-lg w-full">
                                <h3 class="sm:text-lg py-10 lg:py-20 text-4xl text-white font-bold flex justify-center" style="background-image: url('{{ $eventImage->url }}'); background-position: center center;">
                                    イベント
                                </h3>
                                <div class="p-5">
                                    <!-- 募集中のイベントセクション -->
        ...
        <footer class="flex flex-col items-center justify-center bg-blue-500 p-10">
            <h1 class="sm:text-2xl md:text-4xl font-bold text-white">交流プラットフォーム</h1>
